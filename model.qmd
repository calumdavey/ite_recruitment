...
# Collapse by week of application
  # For each week of application: 
  # number of applicants, interviews, offers, acceptances, starts 

# Probabilities each week, fit models, and extract parameters 
...
```{r}
#| echo: true
# Set params from 22-23 analysis (not repeated here)
params_22_23 <- list()

# Build prediction model (N.B. 'data' is new in-year data)
prediction_model <- function(data, params, weight){
  # Use 'data' to update params 
  
  # Predict for each week, number of applicants, etc.
